...
read_reviews = open("auto\comfort_toyota_camry_2007.txt").read() + open("auto\interior_toyota_camry_2007.txt").read() + open("auto\quality_toyota_camry_2007.txt").read()+ open("auto\gas_mileage_toyota_camry_2007.txt").read()
all_words = []
documents = []
